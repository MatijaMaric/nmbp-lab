...
> {
  ...
  private _renderField(label: string, field: string, textArea?: boolean) {
    return (
      <div className="form-field">
        ...
        {textArea
            ? <textarea className="form-field__textarea" name={field} onChange={this.handleInputChange} />
            : <input className="form-field__text" type="text" name={field} onChange={this.handleInputChange} />
        }
  ...
  private handleInputChange = (event: React.ChangeEvent<HTMLInputElement> | React.ChangeEvent<HTMLTextAreaElement>) => {
